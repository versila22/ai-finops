const en = {
  ...
  providerCreateTitle: "Add provider",
  providerCreateDescription: "Create a new provider or subscription to track in AI FinOps.",
  providerCreateSubmit: "Create provider",
  providerCreateSuccess: "Provider added successfully.",
  providerCreateError: "Unable to add provider.",
  providerEditButton: "Edit",
  providerEditTitle: "Edit provider",
  providerEditDescription: "Update tracking and quota information.",
  providerEditSubmit: "Save changes",
  providerEditSuccess: "Provider updated.",
  providerEditError: "Unable to update provider.",
  providerDeleteButton: "Delete",
  providerDeleteConfirmTitle: "Delete this provider?",
  providerDeleteConfirmDescription: (name: string) => `This will delete ${name} and its related data.`,
  providerDeleteConfirmAction: "Delete permanently",
  providerDeleteSuccess: "Provider deleted.",
  providerDeleteError: "Unable to delete provider.",
  providerFormName: "Provider name",
  providerFormNamePlaceholder: "e.g. OpenRouter",
  providerFormLogo: "Logo / Initial",
  providerFormLogoPlaceholder: "e.g. O",
  providerFormCategory: "Category",
  providerFormPlan: "Plan",
  providerFormPlanPlaceholder: "e.g. Pro",
  providerFormPlanType: "Plan type",
  providerFormMonthlyCost: "Monthly cost (€)",
  providerFormIncludedQuota: "Included quota",
  providerFormQuotaUnit: "Quota unit",
  providerFormResetDate: "Reset date",
  providerFormDaysUntilReset: "Days until reset",
  providerFormConsumed: "Consumed",
  providerFormCancel: "Cancel",
  providerFormSaving: "Saving...",
  thProvider: "Provider",
  thPlan: "Plan",
  thCost: "Cost",
